package com.pange.genfee.search.service.impl;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.util.StrUtil;
import com.pange.genfee.search.dao.EsProductDao;
import com.pange.genfee.search.domain.EsProduct;
import com.pange.genfee.search.domain.EsProductRelatedInfo;
import com.pange.genfee.search.repository.EsProductRepository;
...
public class EsProductServiceImpl implements EsProductService {
    ...
    public EsProduct create(Long id) {
        ...
        if(CollectionUtil.isNotEmpty(esProductList)){
                ...
                .subAggregation(AggregationBuilders.filter("productAttrs",QueryBuilders.termQuery("attrValueList.type",1))
                        .subAggregation(AggregationBuilders.terms("attrIds")
                                ...
                                .subAggregation(AggregationBuilders.terms("attrValues")
                                        .field("attrValues.value"))
                                .subAggregation(AggregationBuilders.terms("attrNames")
                                        .field("attrValue.name")))
                );
    ...
    private EsProductRelatedInfo covertProductRelatedInfo(SearchHits<EsProduct> response){
        ...
        for(Terms.Bucket attrId : attrIds){
            ...
            if(CollectionUtil.isNotEmpty(attrNames)){
